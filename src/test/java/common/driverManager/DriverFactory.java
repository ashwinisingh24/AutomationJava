...
public class DriverFactory {
	...
	public static synchronized void setUp(String remoteURL,String browser, String platform) {
		driver = initiateDriver(remoteURL, browser, platform);
		String baseUrl = DataTable_Static.Value(Constant.getTestDataFilePath(), Constant.getEnvironmentInfoSheet(), 1, "url");
